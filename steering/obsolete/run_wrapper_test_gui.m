...
% Paralell processing is purely governed by R using "parallel", "doParallel", and "foreach" package. This Octave code does not support any parallelization by itself.

comid_arg = 'comid_20332660';
...
precip_monthly = readtable(['..\hist\precip_monthly_', comid(7:end), '.csv']); % comid(7:end) extracts actual comid (e.g. 20332660) from into argument string such as "comid_20332660"
